...
// Chart 1
// Chart types
const $dc22a61828523e3d$var$chart1SBS = document.querySelector('#chart1-sidebyside');
const $dc22a61828523e3d$var$chart1Merge = document.querySelector('#chart1-combined');
// Type switcher
const $dc22a61828523e3d$var$chart1btnSBS = document.querySelector('#chart1-switcher-sbs');
const $dc22a61828523e3d$var$chart1btnMerge = document.querySelector('#chart1-switcher-merge');
/*
########################
## Page Functionality ##
########################
...
window.addEventListener('load', function() {
    ...
    $dc22a61828523e3d$var$initChart1();
    $dc22a61828523e3d$var$initChart2();
});
...
function $dc22a61828523e3d$var$initNav() {
    ...
    navHbBtn.addEventListener('click', ()=>{
        ...
        $dc22a61828523e3d$var$pageBody.classList.toggle('expand');
    });
}
// Chart 1 stuff
function $dc22a61828523e3d$var$initChart1() {
    // Type switcher functionality
    // Side by side btn
    $dc22a61828523e3d$var$chart1btnSBS.addEventListener('click', ()=>{
        // Test if it's 'checked'
        if (!$dc22a61828523e3d$var$chart1btnSBS.classList.contains('checked')) $dc22a61828523e3d$var$chart1Toggle();
    });
    //
    $dc22a61828523e3d$var$chart1btnMerge.addEventListener('click', ()=>{
        // Test if it's 'checked'
        if (!$dc22a61828523e3d$var$chart1btnMerge.classList.contains('checked')) $dc22a61828523e3d$var$chart1Toggle();
    });
}
// Toggling element classes en masse
function $dc22a61828523e3d$var$chart1Toggle() {
    $dc22a61828523e3d$var$chart1btnSBS.classList.toggle('checked');
    $dc22a61828523e3d$var$chart1btnMerge.classList.toggle('checked');
    $dc22a61828523e3d$var$chart1SBS.classList.toggle('chart1-hide');
    $dc22a61828523e3d$var$chart1Merge.classList.toggle('chart1-hide');
}
// Chart 2 stuff
function $dc22a61828523e3d$var$initChart2() {
    // DOM
...
//# sourceMappingURL=public.1f6ddfe8.js.map
